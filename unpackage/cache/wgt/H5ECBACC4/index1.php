...
//获取day1的数据
$result =$link->query("select* from booking,category where postdate like'{$day1}' and category.id =booking.cid and aid like'{$id}'");
$result1 =$link->query("select sum(amount) from booking where postdate like'{$day1}' and type like'-1' and aid like'{$id}'");
$result2 =$link->query("select sum(amount) from booking where postdate like'{$day1}' and type like'1' and aid like'{$id}'");
