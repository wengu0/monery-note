...
$result3=$link->query("select* from booking where postdate like '{$today}' and type like '-1' and aid like'{$id}'");
$result4=$link->query("select* from booking where postdate like '{$today}' and type like '1' and aid like'{$id}'");
$result5=$link->query("select* from booking where postdate between '{$week_day1}'and'{$week_day2}' and type like '-1' and aid like'{$id}'");
$result6=$link->query("select* from booking where postdate between '{$week_day1}'and'{$week_day2}' and type like '1' and aid like'{$id}'");
$result7=$link->query("select* from booking where postdate between '{$month_day1}'and'{$month_day2}' and type like '-1' and aid like'{$id}'");
$result8=$link->query("select* from booking where postdate between '{$month_day1}'and'{$month_day2}' and type like '1' and aid like'{$id}'");
$result9=$link->query("select* from booking where postdate between '{$year_day1}'and'{$year_day2}' and type like '-1' and aid like'{$id}'");
$result10=$link->query("select* from booking where postdate between '{$year_day1}'and'{$year_day2}' and type like '1' and aid like'{$id}'");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	echo"</br>"; 
	echo"</br>";
	echo "<p><font size='7' color='white'>" . date("m月") . "</font> </p>"; 
	echo"</br>";
	echo "&nbsp<p>收入".$month_get."&nbsp&nbsp支出".$month_out."</p>"
	?>
    </div>
